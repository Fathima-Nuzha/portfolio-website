...
<section
id="contact"
className="relative min-h-screen scroll-mt-24 py-24 px-6 bg-[#0B1120] text-white overflow-hidden"
>
...
className="bg-gradient-to-b from-[#111827] to-[#0B1120]
border border-blue-500/20 rounded-3xl p-8 text-center
...
className="bg-[#0B1120] border border-blue-500/20
rounded-xl px-4 py-3 focus:border-blue-500 outline-none w-full"
/>
...
className="w-full bg-[#0B1120] border border-blue-500/20
rounded-xl px-4 py-3 focus:border-blue-500 outline-none"
/>
...
hover:bg-blue-400 transition flex justify-center items-center gap-3"
